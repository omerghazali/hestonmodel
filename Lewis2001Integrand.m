function y = Lewis2001Integrand(u,kappa,theta,lambda,rho,sigma,tau,S,K,r,q,v0,Trap)

% Returns the integrand for the formulation in Equation (3.11) of Lewis (2001).
% u = integration variable, is complex
% Heston parameters:
...
u = u + i/2; %removes complex part from input
W = Y - log(K);
